...
import BusdSVG from "../assets/busd.svg";
...
const Hero = () => {
    return (
        <div className="relative bg-gradient-to-r from-[#2A1535] via-[#2A1535] to-[#261865] min-h-screen flex flex-col items-center justify-center text-white bg-opacity-50 overflow-y-hidden">
            <img src={BusdSVG} className="absolute top-1/4 left-1/4 md:left-1/3 transform -translate-x-48 -translate-y-24 h-12 w-12 md:h-12 md:w-12" alt="Ethereum" />
            <img src={BitcoinSVG} className="absolute top-1/2 right-1/4 md:right-1/3 transform translate-x-48 translate-y-24 h-12 w-12 md:h-12 md:w-12" alt="Bitcoin" />
